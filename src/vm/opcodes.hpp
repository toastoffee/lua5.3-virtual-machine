...
const Opcode opcodes[] = {
        ...
        Opcode{0, 0, OpArgK, OpArgK, IABC,  "SETTABUP", Inst::SetTable},
        Opcode{0, 0, OpArgU, OpArgN, IABC,  "SETUPVAL", nullptr},
        Opcode{0, 0, OpArgK, OpArgK, IABC,  "SETTABLE", Inst::NewTable},
        Opcode{0, 1, OpArgU, OpArgU, IABC,  "NEWTABLE", Inst::SetList},
